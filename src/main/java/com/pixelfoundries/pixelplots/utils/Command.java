...
import com.pixelfoundries.pixelplots.PixelPlots;
...
//                                        player1.sendMessage(TextSerializers.FORMATTING_CODE.deserialize("&a Progress of &e" + arg + ": " + PixelPlots.getDatabase().getProgress(Sponge.getServer().getPlayer(arg).get().getUniqueId(), questLine)));
                                    });
...
//                                            PixelPlots.getDatabase().setProgress(Sponge.getServer().getPlayer(arg).get().getUniqueId(), questLine, Integer.parseInt(progress));
                ...
                .build();
        Sponge.getCommandManager().register(PixelPlots.instance, spec, "pp", "pixelplots");
    }
